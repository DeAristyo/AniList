import { listItemStyle } from '../../styles/emotions/list';
		...
		<Link href={`/pokemon/${pokemon.name}`} passHref>
			<div
				...
				<div style={{ width: '100%' }}>
					...
					<div data-testid='pokemon-list-item-extra'>{extra}</div>
					<div data-testid='pokemon-list-item-children'>{children}</div>
				</div>
			</div>
		</Link>
	);
